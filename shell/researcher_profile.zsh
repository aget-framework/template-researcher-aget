#!/bin/zsh
# ============================================================
# Researcher Agent Shell Profile
# ============================================================
# Template: template-researcher-aget
# Version: 3.3.0
#
# DOCUMENTATION
# -------------
# Shell README:    ./shell/README.md
# Template Spec:   ./specs/Researcher_SPEC.md
# Template Vocab:  ./specs/Researcher_VOCABULARY.md
...
# 2. Source this file: source shell/researcher_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-researcher-aget}"
export AGET_ARCHETYPE="researcher"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Researcher_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Researcher_VOCABULARY.md"
