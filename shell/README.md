...
This directory contains shell integration examples for the Researcher template.
...
| File | Purpose |
|------|---------|
| `researcher_profile.zsh` | Example zsh profile for researcher agents |
...
source shell/researcher_profile.zsh
```
...
1. Copy `researcher_profile.zsh` to your instance
...
*Shell integration for template-researcher-aget*
