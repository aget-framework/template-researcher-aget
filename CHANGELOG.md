...
### Added
- Archetype-specific skills: `aget-search-literature`, `aget-document-finding`
- Formal ontology: `ontology/ONTOLOGY_researcher.yaml` (7 concepts, 2 clusters)
...
- README structure: "Why Researcher?" value proposition
